...
```{r IQdista, fig.cap="The population distribution of IQ scores", echo=FALSE, fig.align="center", out.width="100%"}
emphCol <- rgb(0,0,1)
...
IQsamples <- function() {
	...
	plotSamples(10000)
		...
		IQ <- rnorm(100, 100, 15)
		plot <- hist( IQ, breaks=seq(10,180,5), border="white", 
			col=ifelse(colour,emphColLight,emphGrey),
			xlab="IQ Score", ylab="Frequency", xlim=c(60,140),
			main=""
		)
