...
```{r contingencytable, fig.cap="Contingency table for the `speaker` and `utterances` variables", echo=FALSE, fig.align="center", out.width="100%"}
...
```{r contingencyrow, fig.cap="Contingency table for the `speaker` and `utterances` variables, with row percentages", echo=FALSE, fig.align="center", out.width="100%"}

knitr::include_graphics("img/mechanics/contingencyrow.png", error = TRUE)

```

```{r contingencycol, fig.cap="Contingency table for the `speaker` and `utterances` variables, with column percentages", echo=FALSE, fig.align="center", out.width="100%"}
