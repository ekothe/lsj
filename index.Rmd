...
If you notice any errors in this version that are not present in Version 0.70 please report them at https://github.com/ekothe/lsj/issues
...
title.innerHTML = '<img src="img/bookcoverA4.png" alt="Book cover">' + title.innerHTML
```
